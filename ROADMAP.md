...
1. [#140](https://github.com/cenetex/app-ruby-high/issues/140) / [#117](https://github.com/cenetex/app-ruby-high/issues/117):
   ...
   welcome Hall Pass popup, card-burn selector, billing product/payment DOM,
   comic-reader modal rendering, class-report card/next-step rendering, and
   yearbook archive/collectible/share-action plus shared CCG card rendering now
   also delegate to typed renderers/controllers instead of
