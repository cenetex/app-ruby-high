...
- Continue #117 by extracting the public world/feed client behind typed
  ...
  Honor Roll rows, arc indicators, progress labels, public-world lifecycle wiring,
...
1. [#140](https://github.com/cenetex/app-ruby-high/issues/140) / [#117](https://github.com/cenetex/app-ruby-high/issues/117):
   ...
   ordering, filtering, and capping grade-scoped room modifiers. Honor Roll row
   and race-strip participant DOM rendering now also delegate to typed
