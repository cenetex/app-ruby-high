...
| [#140 MMO: typed public-world viewer module](https://github.com/cenetex/app-ruby-high/issues/140) | Open, several seams in #138 | **P1 maintainability.** World feed, world panel, lifecycle wiring, public-world action handling, composed world-controller wiring, race/question/leaderboard/progress models, account AI/wallet/public-world visibility view models, account-history row models, and account character-slot panel/card models are typed; next is extracting the next public-world/account surface still owned by `viewer-parts/client.ts`. |
