...
1. [#140](https://github.com/cenetex/app-ruby-high/issues/140) / [#117](https://github.com/cenetex/app-ruby-high/issues/117):
   ...
   row class/ARIA/chip/state/action decisions and pack-editor teacher row
   selected/avatar/title/subtitle/disabled states now come from typed pure view
   models, leaving the unchecked client to wire DOM events. Welcome Hall Pass
   ...
   presentation, stat-chip, reroll-row, social-card grid, teacher-roll
