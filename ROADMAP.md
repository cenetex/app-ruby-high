...
| [#140 MMO: typed public-world viewer module](https://github.com/cenetex/app-ruby-high/issues/140) | Open, several seams in #138 | **P1 maintainability.** World feed, world panel, lifecycle wiring, public-world action handling, composed world-controller wiring, race/question/leaderboard/progress models, account public-world visibility view models, and account-history row models are typed; next is extracting the next public-world/account surface still owned by `viewer-parts/client.ts`. |
...
1. [#140](https://github.com/cenetex/app-ruby-high/issues/140) / [#117](https://github.com/cenetex/app-ruby-high/issues/117):
   ...
   the unchecked client. Next target: the next large public-world or account
   surface still owned by the unchecked client.
