...
- Continue #117 by extracting the public world/feed client behind typed
  ...
  account public-world visibility models, account trust/history DOM rendering,
  and public-world hide/report actions now live in typed helpers/modules. The
