...
const BUILT_IN_TEACHER_RESEARCH_CORPORA: RubyHighTeacherResearchCorpus[] = [
  ...
  },
  {
    ...
    readingList: [
      ...
      "Crownless dragon ecology design: goblin tribute chains, the Crown Cycle, anti-dragon alliances, and persistent Afterdragon consequences.",
    ...
    canonicalMisconceptions: [
      ...
      "In Crownless, prosperity alone makes the dragon attack.",
    ...
    sourcePackets: [
      ...
      },
      {
        ...
        title: "Crownless dragon ecology packet",
        anchor: "goblin roles, two-stage tribute, hoard ownership, dragon states, couriers, mustering, and Afterdragon effects",
        summary: "Crownless models causality through physical stocks and recorded transfers. Goblins cooperate through specialized roles and material needs; tribute changes ownership only on delivery; dragon hunger differs from retaliation; and alliances require messages, pledges, and real supplies.",
        grades: ["9", "10", "11", "12"],
