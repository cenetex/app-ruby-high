...
<div class="shell" id="shell">
  ...
  <main class="workspace" id="workspace">
    <header class="top-bar">
      ...
      <button class="pack-btn" id="pack-btn" type="button" title="Content packs">
...
<div class="sheet-overlay" id="pack-overlay">
  <div class="sheet-card" id="pack-card">
    <h2>Content packs</h2>
    <p class="sub">Switch which curriculum the school is teaching. Pre-bundled packs are listed below; you can also import your own Anki deck (.apkg).</p>
