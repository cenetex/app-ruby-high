...
<div class="sheet-overlay" id="pack-overlay">
  <div class="sheet-card" id="pack-card">
    ...
    <p class="sub" style="margin: 0 0 10px;">Pick a .apkg file. The first ~50 cards become MC questions; subdecks or strong tags become classes. Distractors are generated by your OpenRouter key. Costs ~$0.05.</p>
