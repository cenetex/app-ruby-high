...
static bool apply_action(Ruby2World* world, Ruby2WorldActionId action_id, bool step_agents) {
  ...
  if (step_agents) ruby2_world_step_agents(world);
  return true;
}
...
static bool apply_demo(Ruby2World* world, const char* demo) {
  ...
  if (strcmp(demo, "homeroom_problem") == 0) {
    return apply_action(world, RUBY2_ACTION_SELECT_AVATAR_SOURCE, false) &&
           apply_action(world, RUBY2_ACTION_COLLECT_NOTEBOOK, false) &&
  ...
  if (strcmp(demo, "cafeteria_receipt") == 0) {
    return apply_action(world, RUBY2_ACTION_SELECT_AVATAR_SOURCE, false) &&
           ...
           apply_action(world, RUBY2_ACTION_ATTEND_HOMEROOM, false) &&
           apply_action(world, RUBY2_ACTION_APPROACH_SOURCE, true) &&
           apply_action(world, RUBY2_ACTION_GO_HALLWAY, true) &&
           apply_action(world, RUBY2_ACTION_GO_CAFETERIA, true);
  }
  ...
  if (strcmp(demo, "receipt_inspected") == 0) {
    return apply_action(world, RUBY2_ACTION_SELECT_AVATAR_SOURCE, false) &&
           ...
           apply_action(world, RUBY2_ACTION_GO_HALLWAY, true) &&
           apply_action(world, RUBY2_ACTION_GO_CAFETERIA, true) &&
           apply_action(world, RUBY2_ACTION_INSPECT_RECEIPT, true);
  }
