...
static void test_render_prompt_hides_mechanical_labels(void) {
  Ruby2PerformanceRequest request = {
    ...
    .memory_context = "i remember the pencil circle around the board mismatch.",
    .location_context = "Homeroom, front board.",
    .items_context = "Answer card, work order, your Notebook.",
...
static void test_render_prompt_wakes_in_order(void) {
  Ruby2PerformanceRequest request = {
    ...
    .memory_context = "i remember the new kid circling the board mismatch before lunch.",
    .location_context = "Cafeteria, tray rail table.",
...
static void test_render_prompt_uses_line_contract(void) {
  Ruby2PerformanceRequest request = {
    ...
    .beat_id = "vertical-approach-resolve",
    .memory_context = "i remember the student choosing the work-order step over the answer card.",
    .location_context = "Homeroom, front board.",
    .items_context = "Answer card, work order, your Notebook.",
    .avatar_context = "Ravi is front row with one hand up.",
    .situation = "Ruby is looking at the answer card, work-order step, and pencil mark.",
    .outcome = "The student checked the work order before trusting the card.",
    .fallback = NULL
  };
  Ruby2RenderedPrompt prompt;
  EXPECT_TRUE(ruby2_llm_render_prompt(&request, &prompt));
